...
function Get-Msi {
    ...
    if (Test-Downlevel) {
        return Get-MsiWithWmi -MsiName $MsiName -MaximumVersion $MaximumVersion
    } else {
        return Get-MsiWithPackageManagement -MsiName $MsiName -MaximumVersion $MaximumVersion
    }
}
...
function Get-MsiWithPackageManagement {
    ...
    $products = Get-Package -Name PowerShell* `
