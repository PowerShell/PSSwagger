...
function Get-SwaggerInfo {
    ...
    if((Get-Member -InputObject $Info -Name 'x-ms-code-generation-settings') -and 
       (Get-Member -InputObject $Info.'x-ms-code-generation-settings' -Name 'OutputDirectory') -and
        $Info.'x-ms-code-generation-settings'.OutputDirectory) {
        $CodeOutputDirectory = $Info.'x-ms-code-generation-settings'.OutputDirectory
    } elseif((Get-Member -InputObject $Info -Name 'x-ms-code-generation-settings') -and 
             (Get-Member -InputObject $Info.'x-ms-code-generation-settings' -Name 'o') -and
              $Info.'x-ms-code-generation-settings'.o) {
        $CodeOutputDirectory = $Info.'x-ms-code-generation-settings'.o
    } elseif((Get-Member -InputObject $Info -Name 'x-ms-code-generation-settings') -and
             (Get-Member -InputObject $Info.'x-ms-code-generation-settings' -Name 'output') -and
              $Info.'x-ms-code-generation-settings'.output) {
        $CodeOutputDirectory = $Info.'x-ms-code-generation-settings'.output
    }

    # When Namespace is specified, we have to use this instead of our autogenerated namespace
    if((Get-Member -InputObject $Info -Name 'x-ms-code-generation-settings') -and 
       (Get-Member -InputObject $Info.'x-ms-code-generation-settings' -Name 'Namespace') -and
       $Info.'x-ms-code-generation-settings'.Namespace) {
        $NameSpace = $Info.'x-ms-code-generation-settings'.Namespace
    } elseif((Get-Member -InputObject $Info -Name 'x-ms-code-generation-settings') -and 
             (Get-Member -InputObject $Info.'x-ms-code-generation-settings' -Name 'n') -and
       $Info.'x-ms-code-generation-settings'.n) {
        $NameSpace = $Info.'x-ms-code-generation-settings'.n
    }
