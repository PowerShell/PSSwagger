...
###PSLOC
    ...
    PSScriptAnalyzerMissing=PSScriptAnalyzer specified as the formatter, but the module is not available on this machine. Install PSScriptAnalyzer from PowerShellGallery to use this as a formatter.
###PSLOC
'@